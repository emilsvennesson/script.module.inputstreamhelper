...
class WindowsX86Tests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        inputstreamhelper.arch = lambda: 'x86'
        inputstreamhelper.widevine.widevine.arch = lambda: 'x86'
        inputstreamhelper.widevine.repo.arch = lambda: 'x86'
